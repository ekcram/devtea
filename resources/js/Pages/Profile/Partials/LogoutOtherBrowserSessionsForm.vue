<template>
    <jet-action-section>
        ...
        <template #description>
            Administrar y cerrar las sesiones activas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puede cerrar sesiones de navegador en otros dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si siente que su cuenta ha sido comprometida, también debe actualizar su contraseña.
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    Cerrar sesiones de navegador en otros dispositivos
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, introduzca su contraseña para confirmar que desea cerrar sesiones de navegador en todos sus dispositivos.
