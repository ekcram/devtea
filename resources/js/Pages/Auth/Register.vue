     ...
     <Head title="Register" />
      ...
      <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            <div class="mt-4">
                <jet-label for="name" value="Nombre" class="text-lg font-inter text-midnight-green text-bold"/>
                <jet-input id="name" type="text" class="mt-1 block w-full" v-model="form.name" required autofocus autocomplete="name" />
            </div>

            <div class="mt-4">
                <jet-label for="surname" value="Apellidos" class="text-lg font-inter text-midnight-green text-bold" />
                <jet-input id="surname" type="text" class="mt-1 block w-full" v-model="form.surname" required autofocus autocomplete="surname" />
            </div>

            <div class="mt-4">
                <jet-label for="username" value="Username" class="text-lg font-inter text-midnight-green text-bold"/>
            ...
            <div class="mt-4">
                <jet-label for="password_confirmation" value="Confirmar contraseña" class="text-lg font-inter text-midnight-green text-bold"/>
                <jet-input id="password_confirmation" type="password" class="mt-1 block w-full" v-model="form.password_confirmation" required autocomplete="new-password" />
            </div>

            <div class="mt-4">
                <jet-label for="gender" value="Género" class="text-lg font-inter text-midnight-green text-bold"/>
            ...
            <div class="mt-4" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                <jet-label for="terms">
                    <div class="flex items-center">
                        <jet-checkbox name="terms" id="terms" :checked="form.terms" />
